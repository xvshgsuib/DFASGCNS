...
if __name__ == '__main__':
    ...
    for k_num in range(20):
        ...
        with open('Regularizer_eval_randomseed' + str(k_num) + '.log', 'a') as f:
        ...
        while True:
            ...
            with open('Regularizer_eval_randomseed' + str(k_num) + '.log',
                      'a') as f:
        ...
        with open('Regularizer_eval_AVE_Cind' + '.log', 'a') as f:
